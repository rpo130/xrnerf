...
test_hooks = [
    ...
    dict(type='TestHook', params=dict(save_img=True, dump_json=True)),
]
...
work_dir = './work_dirs/avt/nerf_#DATANAME#_base01/'
...
N_rand_per_sampler = 1024 * 4 // 4 // 4 # how many N_rand in get_item() function
...
model = dict(
    ...
    cfg=dict(
        ...
        chunk=1024 * 32 // 32,  # mainly work for val
    ...
    mlp=dict(  # coarse model
        ...
        netchunk=1024 * 32 // 32,  # number of pts sent through network in parallel;
...
testdata_cfg.update(dict(mode='test', testskip=8))
