...
N_rand_per_sampler = 1024 * 4 // 2 # how many N_rand in get_item() function
...
model = dict(
    ...
    cfg=dict(
        ...
        chunk=1024 * 32 // 8,  # mainly work for val
        bs_data=
    ...
    mlp=dict(  # coarse model
        ...
        netchunk=1024 * 32 // 8,  # number of pts sent through network in parallel;
