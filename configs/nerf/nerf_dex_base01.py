...
work_dir = './work_dirs/dex/nerf_#DATANAME#_base01/'
...
model = dict(
    ...
    cfg=dict(
        ...
        chunk=1024 * 32 // 32 // 2,  # mainly work for val
    ...
    mlp=dict(  # coarse model
        ...
        netchunk=1024 * 32 // 32 // 2,  # number of pts sent through network in parallel;
